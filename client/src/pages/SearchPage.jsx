...
import { getSuggestions, searchPages } from "../services/SearchApi";
  ...
  return (
    <div className="flex flex-col bg-gray-800 text-white min-h-screen flex items-center">
      ...
      {suggestion?.map((suggestion) => (
        <div key={suggestion} onClick={() => setSearchInput(suggestion)} className="w-full max-w-4xl bg-black flex px-4">
